...
class ConfigExtraSetting(ConfigSetting):
    ...
    def validate(self) -> None:
        ...
        extra_picasso_settings_schemas = Schema(
            {
                Optional("PICASSO_EXTRA_MIDDLEWARES"): And(list),
                Optional("PICASSO_DISABLE_MFE"): And(bool),
            },
        ...
        try:
            extra_picasso_settings_schemas.validate(self.config)
        except SchemaError as error:
